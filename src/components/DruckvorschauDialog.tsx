    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="druckvorschau-dialog max-w-5xl w-[95vw] h-[92vh] p-0 flex flex-col gap-0 overflow-hidden">
          ...
          <div className="flex-1 grid md:grid-cols-[240px_1fr] overflow-hidden">
            <aside className="border-b md:border-b-0 md:border-r border-border bg-muted/30 p-4 overflow-y-auto">
